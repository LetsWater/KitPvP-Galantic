...
public class archerKit_1 {

    public void giveArcherKit_1(UUID uuid){
        Player p = Bukkit.getServer().getPlayer(uuid);

        ItemStack stoneSword = new ItemStack(new ItemBuilder(Material.STONE_SWORD, 1).setDisplayName("&bArcher").setLore("&8- &fLevel: &e1")
                .setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());

        ItemStack bow = new ItemStack(new ItemBuilder(Material.BOW, 1).setDisplayName("&bArcher").setLore("&8- &fLevel: &e1")
        ...
        ItemStack chainHelmet = new ItemStack(new ItemBuilder(Material.CHAINMAIL_HELMET, 1)
                .setDisplayName("&bArcher").setLore("&8- &fLevel: &e1").setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
        ...
        ItemStack chainLeggings = new ItemStack(new ItemBuilder(Material.CHAINMAIL_LEGGINGS, 1)
                .setDisplayName("&Archer").setLore("&8- &fLevel: &e1").setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
