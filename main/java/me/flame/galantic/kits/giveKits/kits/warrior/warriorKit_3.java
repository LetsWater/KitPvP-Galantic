...
public class warriorKit_3 {

    public void giveWarriorKit_3(UUID uuid){
        Player p = Bukkit.getServer().getPlayer(uuid);

        ItemStack diamondSword = new ItemStack(new ItemBuilder(Material.DIAMOND_SWORD, 1)
                .setDisplayName("&bWarrior").setLore("&8- &fLevel: &e3").setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
