...
public class ninjaKit_4 {

    public void giveNinjaKit_4(UUID uuid){
        ...
        ItemStack ironSword = new ItemStack(new ItemBuilder(Material.IRON_SWORD, 1)
                ...
                .setDisplayName("&bNinja").setLore("&8- &fLevel: &e4").setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
