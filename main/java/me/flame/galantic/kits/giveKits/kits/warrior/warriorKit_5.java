...
public class warriorKit_5 {

    public void giveWarriorKit_5(UUID uuid){
        ...
        ItemStack diamondSword = new ItemStack(new ItemBuilder(Material.DIAMOND_SWORD, 1)
                ...
                .setDisplayName("&bWarrior").setLore("&8- &fLevel: &e5").setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
