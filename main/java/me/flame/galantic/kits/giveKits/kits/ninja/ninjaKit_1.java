...
public class ninjaKit_1 {

    public void giveNinjaKit_1(UUID uuid){
        ...
        ItemStack ironSword = new ItemStack(new ItemBuilder(Material.IRON_SWORD, 1)
                .setDisplayName("&bNinja").setLore("&8- &fLevel: &e1").setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
