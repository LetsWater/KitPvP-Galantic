...
public class warriorKit_1 {

    public void giveWarriorKit_1(UUID uuid){
        Player p = Bukkit.getServer().getPlayer(uuid);

        ItemStack diamondSword = new ItemStack(new ItemBuilder(Material.DIAMOND_SWORD, 1)
                .setDisplayName("&bWarrior").setLore("&8- &fLevel: &e1").setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
