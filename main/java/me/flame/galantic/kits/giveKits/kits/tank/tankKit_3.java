...
public class tankKit_3 {
    ...
    public void giveTankKit_3(UUID uuid) {
        ...
        ItemStack stoneSword = new ItemStack(new ItemBuilder(Material.STONE_SWORD, 1).setDisplayName("&bTank").setLore("&8- &fLevel: &e3")
                .setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());

        ItemStack ironHelmet = new ItemStack(new ItemBuilder(Material.IRON_HELMET, 1).setDisplayName("&bTank").setLore("&8- &fLevel: &e3")
                .addEnchantment(1, Enchantment.PROTECTION_ENVIRONMENTAL)
                .setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
        ItemStack diamondChestplate = new ItemStack(new ItemBuilder(Material.DIAMOND_CHESTPLATE, 1).setDisplayName("&bTank").setLore("&8- &fLevel: &e3")
                .addEnchantment(1, Enchantment.PROTECTION_PROJECTILE)
                .setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
        ItemStack ironLeggings = new ItemStack(new ItemBuilder(Material.IRON_LEGGINGS, 1).setDisplayName("&bTank").setLore("&8- &fLevel: &e3")
                .addEnchantment(1, Enchantment.PROTECTION_PROJECTILE)
                .setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
        ItemStack ironBoots = new ItemStack(new ItemBuilder(Material.IRON_BOOTS, 1).setDisplayName("&bTank").setLore("&8- &fLevel: &e3")
                .addEnchantment(1, Enchantment.PROTECTION_ENVIRONMENTAL)
                .setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
