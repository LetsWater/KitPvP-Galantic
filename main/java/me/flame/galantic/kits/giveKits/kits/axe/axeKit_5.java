...
public class axeKit_5 {

    public void giveAxeKit_5(UUID uuid){
        Player p = Bukkit.getServer().getPlayer(uuid);

        PotionEffect effect = new PotionEffect(PotionEffectType.JUMP, 999999, 1);
        p.addPotionEffect(effect);

        ItemStack ironAxe = new ItemStack(new ItemBuilder(Material.IRON_AXE, 1).setDisplayName("&bAxe").setLore("&8- &fLevel: &e5")
                .addEnchantment(1, Enchantment.DAMAGE_ALL)
                .setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());

        ItemStack ironHelmet = new ItemStack(new ItemBuilder(Material.IRON_HELMET, 1).setDisplayName("&bAxe").setLore("&8- &fLevel: &e5")
                .addEnchantment(1, Enchantment.PROTECTION_ENVIRONMENTAL)
                .setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
        ItemStack ironChestplate = new ItemStack(new ItemBuilder(Material.IRON_CHESTPLATE, 1).setDisplayName("&bAxe").setLore("&8- &fLevel: &e5")
                .addEnchantment(2, Enchantment.PROTECTION_ENVIRONMENTAL)
                .setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
        ItemStack ironLeggings = new ItemStack(new ItemBuilder(Material.IRON_LEGGINGS, 1).setDisplayName("&bAxe").setLore("&8- &fLevel: &e5")
                .addEnchantment(2, Enchantment.PROTECTION_ENVIRONMENTAL)
                .setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
        ItemStack ironBoots = new ItemStack(new ItemBuilder(Material.IRON_BOOTS, 1).setDisplayName("&bAxe").setLore("&8- &fLevel: &e5")
                .addEnchantment(1, Enchantment.PROTECTION_ENVIRONMENTAL)
                .setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
