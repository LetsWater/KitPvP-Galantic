...
public class ninjaKit_3 {

    public void giveNinjaKit_3(UUID uuid){
        ...
        ItemStack ironSword = new ItemStack(new ItemBuilder(Material.IRON_SWORD, 1)
                .setDisplayName("&bNinja").setLore("&8- &fLevel: &e3").setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
