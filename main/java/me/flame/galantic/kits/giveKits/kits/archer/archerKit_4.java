...
public class archerKit_4 {

    public void giveArcherKit_4(UUID uuid){
        Player p = Bukkit.getServer().getPlayer(uuid);

        ItemStack stoneSword = new ItemStack(new ItemBuilder(Material.STONE_SWORD, 1).setDisplayName("&bArcher").setLore("&8- &fLevel: &e4")
                .setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());

        ItemStack bow = new ItemStack(new ItemBuilder(Material.BOW, 1).setDisplayName("&bArcher").setLore("&8- &fLevel: &e4")
        ...
        ItemStack chainHelmet = new ItemStack(new ItemBuilder(Material.CHAINMAIL_HELMET, 1)
                ...
                .setDisplayName("&bArcher").setLore("&8- &fLevel: &e4").setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
