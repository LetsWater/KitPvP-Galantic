...
public class healerKit_4 {

    public void giveHealerKit_4(UUID uuid) {
        Player p = Bukkit.getServer().getPlayer(uuid);

        ItemStack diamondAxe = new ItemStack(new ItemBuilder(Material.DIAMOND_AXE, 1).setDisplayName("&bHealer").setLore("&8- &fLevel: &e4")
                .addEnchantment(1, Enchantment.DAMAGE_ALL)
                .setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());

        ItemStack helmet = new ItemStack(new ItemBuilder(Material.CHAINMAIL_HELMET, 1).setDisplayName("&bHealer").setLore("&8- &fLevel: &e4")
                .addEnchantment(1, Enchantment.PROTECTION_ENVIRONMENTAL)
                .setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
        ItemStack chestplate = new ItemStack(new ItemBuilder(Material.GOLD_CHESTPLATE, 1).setDisplayName("&bHealer").setLore("&8- &fLevel: &e4")
                .addEnchantment(2, Enchantment.PROTECTION_ENVIRONMENTAL)
                .setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
        ItemStack leggings = new ItemStack(new ItemBuilder(Material.CHAINMAIL_LEGGINGS, 1).setDisplayName("&bHealer").setLore("&8- &fLevel: &e4")
                .addEnchantment(2, Enchantment.PROTECTION_ENVIRONMENTAL)
                .setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
        ItemStack boots = new ItemStack(new ItemBuilder(Material.GOLD_BOOTS, 1).setDisplayName("&bHealer").setLore("&8- &fLevel: &e4")
                .addEnchantment(1, Enchantment.PROTECTION_ENVIRONMENTAL)
                .setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
