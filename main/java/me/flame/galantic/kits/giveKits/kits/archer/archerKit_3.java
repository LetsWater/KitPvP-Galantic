...
public class archerKit_3 {

    public void giveArcherKit_3(UUID uuid){
        Player p = Bukkit.getServer().getPlayer(uuid);

        ItemStack stoneSword = new ItemStack(new ItemBuilder(Material.STONE_SWORD, 1).setDisplayName("&bArcher").setLore("&8- &fLevel: &e3")
                .setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());

        ItemStack bow = new ItemStack(new ItemBuilder(Material.BOW, 1).setDisplayName("&bArcher").setLore("&8- &fLevel: &e3")
        ...
        ItemStack chainHelmet = new ItemStack(new ItemBuilder(Material.CHAINMAIL_HELMET, 1)
                ...
                .setDisplayName("&bArcher").setLore("&8- &fLevel: &e3").setUnbreakable().setItemFlag(ItemFlag.HIDE_UNBREAKABLE).build());
